                ...
                <div className="flex">
                    ...
                    <div className="ml-3">
                        <p className="text-sm text-yellow-700">
                            Deze module ({title}) is momenteel in ontwikkeling.
                        </p>
                    </div>
                </div>
            </div>
...
export const SuppliersPage = () => <PlaceholderPage title="Leveranciers" />;
export const AssignmentsPage = () => <PlaceholderPage title="Opdrachten" />;
export const SettingsPage = () => <PlaceholderPage title="Instellingen" />;
